...
void main() {
  ...
  group('Test Product Object Injection', () {
    ...
    test('Test Example Product JSON Import Object conversion', () {
      ...
      expect(exampleProduct.quoteMaxSize, Decimal.parse('1000000.00'));
      expect(exampleProduct.baseMinSize, Decimal.parse('0.0001'));
      expect(exampleProduct.baseMaxSize, Decimal.parse('200'));
      ...
      expect(exampleProduct.midMarketPrice, Decimal.parse('43423.00'));
      ...
      expect(exampleProduct.priceIncrement, Decimal.parse('0.01'));
      expect(exampleProduct.displayName, 'BTC/USD');
      expect(exampleProduct.productVenue, 'CBE');
      expect(
          exampleProduct.approximateQuote24hVolume, Decimal.parse('536000000'));
      expect(exampleProduct.newAt, DateTime.parse('2023-01-01T00:00:00Z'));
      expect(exampleProduct.marketCap, Decimal.parse('850000000000'));
    });
    ...
    test('Example Product JSON Import, Serialize, deserialize', () {
      ...
      expect(deserializedProduct.quoteMaxSize, Decimal.parse('1000000.00'));
      expect(deserializedProduct.baseMinSize, Decimal.parse('0.0001'));
      expect(deserializedProduct.baseMaxSize, Decimal.parse('200'));
      ...
      expect(deserializedProduct.midMarketPrice, Decimal.parse('43423.00'));
      ...
      expect(deserializedProduct.priceIncrement, Decimal.parse('0.01'));
      expect(deserializedProduct.displayName, 'BTC/USD');
      expect(deserializedProduct.productVenue, 'CBE');
      expect(deserializedProduct.approximateQuote24hVolume,
          Decimal.parse('536000000'));
      expect(deserializedProduct.newAt, DateTime.parse('2023-01-01T00:00:00Z'));
      expect(deserializedProduct.marketCap, Decimal.parse('850000000000'));
